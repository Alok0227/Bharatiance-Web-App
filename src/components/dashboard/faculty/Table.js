...
const Table = ({
  ...
  return (
    <tr>
      <td style={{ fontWeight: "700", fontSize: "36", textAlign:"center" }}>{index}</td>
      ...
      <td>
        ...
        <select name="status" style={{"overflow":"hidden"}} class="form-select" value={status} size="3" aria-label="size 3 select example" onChange={(e) => onChange(e)}>
...
const mapStateToProps = (state) => ({ auth: state.auth, faculty: state.faculty });
